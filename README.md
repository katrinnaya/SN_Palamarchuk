...
### Задание 3. Список событий для аудита

* `onboarding.case.created` — Создан новый кейс в процессе онбординга.

* `onboarding.case.solution.linked` — К кейсу онбординга привязано эталонное решение.

* `onboarding.solution.draft.created` — Создан черновик нового эталонного решения для онбординга.

* `onboarding.solution.published` — Эталонное решение по онбордингу опубликовано.

* `onboarding.task.completed` — Завершен один из этапов онбординга (например, "выдано оборудование").

### Задание 4. UX-поток для прямого сценария онбординга
